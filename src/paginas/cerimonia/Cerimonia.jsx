...
function Cerimonia() {
    ...
    return (
        <>
            ...
            <div className="local">
                <img className="pt-4" src={Local} alt="" width={1000} />
                <div id="endereco">
                    <h2>QUALITY HOTEL ARACAJU</h2>
                    <p>Av. Delmiro Gouveia, 100 - Coroa do Meio, Aracaju - SE, 49035-500</p>
                </div>
            </div>
            <div className="paragrafo-local d-flex flex-column text-center justify-content-center align-items-center mt-3">
                <p>A celebração da nossa união está se aproximando e a alegria <br></br> desse dia estará completa com você ao nosso lado.</p>
                <p>Contamos com a presença de todos para celebrarmos o nosso <br></br>amor no dia <b>14 de Março de 2026</b>, pontualmente às <b>16h30.</b></p>
            </div>
